...
describe(`error test`, () => {
  ...
  it.skip(`use the callback style setState on onChange`, async () => {
    await new Promise(async (resolve, reject) => {
      const ref = React.createRef();
      let errorDone = false;
  ...
  it.skip(`change the viewType when uploading`, async () => {
  ...
  it.skip(`change the viewType when uploaded`, async () => {
  ...
  it.skip(`continue the task when the task stop before`, async () => {
  ...
  it.skip(`retry the task when the task error before`, async () => {
  ...
  it.skip(`use the ref to get the task`, async () => {
